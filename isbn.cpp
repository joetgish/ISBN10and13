...
// Issue git add. enter and then git commit
...
int main()
{
    ...
    assert (isValidISBN10(sumISBN10Digits("1132442249"))== true);
    assert (isValidISBN10(sumISBN10Digits("0133591743")) == true);
