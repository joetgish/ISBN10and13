// Joe Welch, and Thalia Villalobos
...
int main()
{
   ...
   //Two test case for each to passed 
    assert(sumISBN10Digits("4895423617") == 292);
    assert(sumISBN10Digits("789456786X") == 376);
    assert(sumISBN13Digits("4617892354456") == 132);
    assert(sumISBN13Digits("1489762345789") == 143);
   
   //Two test case for each to fail
    assert(isValidISBN10(sumISBN10Digits("948954X235")) == 0);
    assert(isValidISBN10(sumISBN10Digits("9454646163895")) == 0);
    assert(isValidISBN10(sumISBN13Digits("4617892X54456")) == 0);
    assert(isValidISBN10(sumISBN13Digits("46178")) == 0);
