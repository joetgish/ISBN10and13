...
int main()
{
    ...
    string strAB = "0185353304";
    string strABC = "0385353302";
    string strABCD = "0182351304";
    
    string strB = "9780136091813";   // test case for ISBN13
    string strBB = "9780152091811";
    string strC = "9780116097813";
    string strBBB = "2780136491843";
    
    //test case for ISBN10 (PASS)
    assert(sumISBN10Digits(strA) % 11 == 0);
    assert(sumISBN10Digits(strAB) % 11 == 0);
    
    //test case for ISBN10 (FAIL)
    assert(sumISBN10Digits(strABCD) % 11 != 0);
    assert(sumISBN10Digits(strABC) % 11 != 0);
    
    //test case for ISBN13 (PASS)
    assert(sumISBN13Digits(strB) % 10 == 0);
    assert(sumISBN13Digits(strBB) % 10 == 0);
    
    //test case for ISBN13 (FAIL)
    assert(sumISBN13Digits(strBBB) % 10 != 0);
    assert(sumISBN13Digits(strC) % 10 != 0);
